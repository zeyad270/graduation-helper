...
Future<void> _pickDocuments(ImageSource source) async {
  ...
  Future<void> _fillMissingFields() async {
    ...
    try {
      ...
      final filledFields = result['filledFields'] as Map<String, dynamic>? ?? {};
          ...
          if (val is Map) {
            ...
            if (value.isNotEmpty) {
              ...
              if (key == 'students' && _studentNames.isEmpty) {
                _studentNames = value.split(RegExp(r'[,;|]'))
                    .map((e) => e.trim())
                    .where((e) => e.length > 2)
                    .toList();
              }
      ...
      _showSnack(msg, type: newCount > 0 ? _SnackType.success : _SnackType.warning);
    } catch (e) {
  ...
  Future<void> _generateFieldFromContext(TextEditingController ctrl, String key) async {
    ...
    try {
      ...
      if (value.isNotEmpty) {
        ...
        _showSnack('Could not generate $key from context', type: _SnackType.warning);
      }
    } catch (e) {
  ...
  Future<void> _generateSummary() async {
    ...
    try {
      ...
      if (summary.isNotEmpty) {
        ...
        _showSnack('Add more fields first for a better summary', type: _SnackType.warning);
      }
    } catch (e) {
      _showSnack('Error: $e', type: _SnackType.error);
    } finally {
    ...
    return SingleChildScrollView(
      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.stretch, children: [
        ...
        _field(_titleCtrl,      'Project Title', Icons.title_rounded,
            reExtractKey: 'title', generateKey: 'title'),
        const SizedBox(height: 12),
        _studentsField(),
        const SizedBox(height: 12),
        Row(children: [
          Expanded(child: _field(_yearCtrl, 'Year', Icons.calendar_today_rounded,
              keyboardType: TextInputType.number, generateKey: 'year')),
        ...
        const SizedBox(height: 12),
        _field(_techCtrl, 'Technologies', Icons.code_rounded,
            reExtractKey: 'technologies', generateKey: 'technologies'),
        const SizedBox(height: 12),
        _field(_keywordsCtrl, 'Keywords', Icons.tag_rounded,
            reExtractKey: 'keywords', generateKey: 'keywords'),

        const SizedBox(height: 20),
        _sectionHeader('Content', Icons.article_outlined),
        _field(_abstractCtrl,   'Abstract',    Icons.article_rounded,
            maxLines: 5, reExtractKey: 'abstract', generateKey: 'abstract'),
        const SizedBox(height: 12),
        _field(_descCtrl,       'Description', Icons.notes_rounded,
            maxLines: 5, reExtractKey: 'description', generateKey: 'description'),

        const SizedBox(height: 20),
        _sectionHeader('Problem & Solution', Icons.lightbulb_outline_rounded),
        _field(_problemCtrl,    'Problem Statement',  Icons.report_problem_rounded,
            maxLines: 4, reExtractKey: 'problem', generateKey: 'problem'),
        const SizedBox(height: 12),
        _field(_solutionCtrl,   'Proposed Solution',  Icons.check_circle_rounded,
            maxLines: 4, reExtractKey: 'solution', generateKey: 'solution'),
        const SizedBox(height: 12),
        _field(_objectivesCtrl, 'Objectives',         Icons.flag_rounded,
            maxLines: 4, reExtractKey: 'objectives', generateKey: 'objectives'),
      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        ...
        Row(children: [
          ...
          Container(
            ...
            decoration: BoxDecoration(
              color: hasAny ? _M3.aiAccent.withOpacity(0.12) : _M3.surfaceVariant,
        ...
        Row(children: [
          ...
          Expanded(child: _aiActionBtn(
            ...
            sublabel: _projectSummary.isNotEmpty ? 'Tap to refresh' : 'Generate now',
            color:    _M3.tertiary,
          ...
          child: Row(children: [
            ...
            IconButton(
              ...
              icon: _isSummaryGenerating
                  ...
                  : Icon(Icons.refresh_rounded, size: 18, color: _M3.tertiary),
        ...
        if (_isSummaryGenerating)
          const Padding(
            ...
            child: Center(child: Column(children: [
              ...
              SizedBox(height: 12),
              Text('Generating summary...', style: TextStyle(fontSize: 13)),
            ])),
          )
        else
          Padding(
  ...
  Widget _field(
    ...
    final isGenerating = generateKey != null && (_fieldGenerating[generateKey] ?? false);
    ...
    return TextField(
      ...
      decoration: InputDecoration(
        ...
        suffixIcon: _buildFieldSuffixIcons(ctrl, reExtractKey, generateKey, isGenerating),
        filled:     true,
            ...
            : Tooltip(
                ...
                child: IconButton(
                  icon: const Icon(Icons.psychology_rounded, size: 18,
                      color: Color(0xFF6B52AE)),
                  onPressed: () => _generateFieldFromContext(ctrl, generateKey),
          ...
          child: isGenerating
              ...
              : IconButton(
                  icon: const Icon(Icons.psychology_rounded, size: 20,
                      color: Color(0xFF6B52AE)),
                  onPressed: () => _generateFieldFromContext(_studentEntryCtrl, 'students'),
